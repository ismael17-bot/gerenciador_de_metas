...
import { PendingGolas } from "./pending-goals";
                ...
                {goals.map(goal => {
                  ...
                  return (
                    <li key={goal.id} className="flex items-center gap-2">
                      ...
                      <span className="text-sm text-zinc-400">Você completou "<span className="text-zinc-100 capitalize">{goal.title}</span>" às <span className="text-zinc-100">{time}h</span></span>
                    </li>
                  )
                })}
              </ul>
